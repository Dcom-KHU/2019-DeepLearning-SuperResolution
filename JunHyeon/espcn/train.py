...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_epochs', default=2000, type=int, help='super resolution epochs number')
    ...
    scheduler = MultiStepLR(optimizer, milestones=[30, 80, 200], gamma=0.2)
